  ...
  class PhoneDeliveryPresenter < TwoFactorAuthCode::GenericDeliveryPresenter
    ...
    def cancel_link
      if confirmation_for_phone_change || reauthn
        ...
        verify_cancel_path(locale: LinkLocaleResolver.locale)
      else
    ...
    def phone_link_tag
      view.link_to(
          ...
          otp_send_path( locale: LinkLocaleResolver.locale, otp_delivery_selection_form: {otp_delivery_preference: fallback_method})
      )
    end
    ...
    def resend_code_link
      view.link_to(
          ...
          otp_send_path(locale: LinkLocaleResolver.locale,
              otp_delivery_selection_form: { otp_delivery_preference: otp_delivery_preference, resend: true }
          )
      )
    end
  end
